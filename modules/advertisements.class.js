class Advertisements {
	...
	async create(data){
		try {
			...
			return this.formatOkMessage(creationResult._doc);
		} catch (e) {
	...
	formatOkMessage(userCreationResult) {
		return {
			data: {
				...userCreationResult
			},
	...
	async getAll(){
		try {
			const results = await this.advertisementModel.find();
			return this.formatOkMessage(results);
		} catch (e) {
			return Promise.reject(e);
		}
	}
